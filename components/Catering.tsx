...
export function Catering() {
  return (
    <section id="catering" className="flex w-full justify-center bg-maroon-900 px-5 py-10 md:px-16 md:py-16">
      <div className="flex w-full max-w-[720px] flex-col items-center gap-4 text-center md:gap-5">
        ...
        <h2 className="font-display text-[30px] font-semibold text-cream-0 md:text-[44px]">
          Great Food for Your Next Event
        </h2>
        <p className="max-w-[560px] text-sm leading-relaxed text-cream-50/80 md:text-base">
