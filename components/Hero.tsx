...
export function Hero() {
  return (
    <section id="top" className="relative h-[620px] w-full overflow-hidden bg-maroon-900 md:h-[780px]">
      ...
      <div className="absolute inset-x-5 bottom-8 flex flex-col gap-4 md:inset-x-16 md:inset-y-0 md:bottom-auto md:flex md:max-w-[640px] md:flex-col md:justify-center md:gap-6">
        ...
        <p className="max-w-[520px] text-[15px] leading-relaxed text-cream-50/85 md:text-lg">
          ...
          and more &mdash; made fresh, served warm, right here in Aspley.
        </p>
        ...
        <div className="mt-2 flex items-start gap-2.5 rounded-2xl border border-cream-50/20 bg-cream-50/10 px-4 py-3 md:mt-4 md:w-fit md:items-center">
          ...
          <span className="text-[13px] leading-snug text-cream-50/90 md:text-sm">
            <span className="font-semibold text-cream-0 md:mr-2">Dosa Hut Aspley</span>
